...
<html>
			...
			<basefont face="Arial">
					...
					<body>
						<fieldset style="width: 50%; margin: auto;">
							<legend>Input mata pelajaran</legend>
    ...
    thead tr {
		...
		<h1 align="center">Tabel mata_pelajaran</h1>
			<table border="1">
				<thead>
					<tr>
						<th>kode_mapel</th>
...
?>
				<tr>
					...
					<td>	
						<a href="hapusguru.php?kode_mapel=<?php echo $tampilkan['kode_mapel']; ?>">
						<input type="button" onclick="return confirm('Anda Mau Hapus Data <?php echo $tampilkan['kode_mapel']; ?> ?');" value="Hapus"></a> | 
						<a href="editguru.php?kode_mapel=<?php echo $tampilkan['kode_mapel']; ?>"><input type="button" value="Edit"/>
