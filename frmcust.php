...
?>
				<tr>
					...
					<td>	
						<a href="deletecust.php?CUST_CODE=<?php echo $tampilkan['CUST_CODE']; ?>">
						<input type="button" onclick="return confirm('Anda Mau Hapus Data <?php echo $tampilkan['CUTS_NAME']; ?> ?');" value="Hapus"></a> | 
						<a href="frmeditcust.php?CUST_CODE=<?php echo $tampilkan['CUST_CODE']; ?>"><input type="button" value="Edit"/>
